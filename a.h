...
#define l0 5 
#define n0 (1LL<<l0)//vector register size
...
typedef char d2 AV(l0-2),V AV(l0);typedef unsigned u,d1 AV(l0-1),Vu AV(l0);typedef unsigned long long U,U4 AV(4),VU AV(l0),UU AV(l0+1),(*Uf)(U),(*UF)(U,U),(*Uns)(u,char*);
...
g(X9,-f^bi(neon_vmull_p64)(x,-1L))X x8={1,2,4,8,16,32,64,128,1,2,4,8,16,32,64,128};
U(b_,Xz=z(padd)(x0&x8,x1&x8,48);i(2,z=z(padd)(z,z,48))*(u*)&z,Va)
U(B_,0,Va)V(sq,a,Va)VF(A0,a)VF(lu,a)VF(mu,a)VF(mg,a)
#else
...
AN(_start,"lea 8(%rsp),%rsi;call main")U(b_,z(pmovmskb)(a),Va)U(B_,z(movmskps)(a),Ve a)VF(ag,a+b)VF(lg,z(pminub)(a,b))VF(mg,z(pmaxub)(a,b))VF(ai,(Vu)a+(Vu)b)VF(lu,z(pminud)(a,b))VF(mu,z(pmaxud)(a,b))VF(ae,(Ve)a+(Ve)b)
...
#define Zu static u
Zu N=1<<31,L[]={3,0,0,2,2,3};Ui(tb,t(1,i))Ui(tc,t(2,i))Ui(ti,t(3,i))
g(tn,1==f?7+x>>3:x<<L[f])static float E[]={1,10,100,1e3,1e4,1e5,1e6,1e7,1e8,1e9};
...
Ui(g_,in=95<<23;ij=N&i;j>>2|b(29)&m(n,i)-n)Ui(_g,in=95<<23;ij=i&b(29);j?N&i<<2|j+n:0)f(G_,g_(x)|g_(x>>32)<<30)f(_G,_g(x)|_g(x>>30)<<32)
...
F(a0,ii=0;$4(Tx-1,xc&=254,xc=a,xu=a,xU=a);x)g(T,ii=x?lb(n0+tn(f,x)-1)-l0-1:0;r(M_(i)+n0,RH=i<<16|f<<24|x<<32))v1(_t,3>Tx?_N(mg(B+Z,O+(26>O-65&32))):_T(Tx-1,5>Tx?C(Vi,Ex):(Vu)sq(_u*_u+u_*u_)))
...
U(jk,R_(R(Tx,n-i,dn(r,(U)n-i<<Lx,x+(i<<Lx)))),int i,in,Ux)F(pr,a0(a,jk(-1,nx-1,x)))
F(dx,Un=Nx;ij=n%n0;a=dn(a,n-=j,x);i(j,ac=sx[n+i])a+j)F(V_,Qz(Bx)_a(R_(_R(Ta,na+nx,dx(dn(r,x(a,Nx),a),x)))))
...
f(n_,_R(3,sb(x),u*s=sr;N6(Ua=xU;j(nb(a),*s++=64*i+IB(a)))))f(ext,Ua=N(B<O);_a(_R(2,(char)-fo(2,a),ss=sr;i(7+nx>>3,*(U*)s=bi(ia32_pext_di)(xU,aU);s+=nb(aU)/8))))
F(_V,_a(_(K(na,jk(au,i+1<na?((u*)a)[i+1]:nx,x)))))Ui(c1,v_(tc(i)))g(vc,V_(x,c1(f)))
f(Ss,Ua=pr(x_,x);cc=*sa;a=x(a,_(bC(c==O)));a=n_(a);x=_V(a,x);n(a(xU,sa)[--nU]=0)x)
g(sS,in=f?nx:0;ij;n(Qt(a(xU,ta||2!=Ta))n+=j=nU)_R(a(xx,Ta),n,Ua=r;n(if(a=dx(a,xU),f)*sa++=f)))
...
f($a,x=$3(tx-3,$i(ux),$e(ex),x=_G(x);Ua=$e(ex);x>>=32;a|(14|$e(ex)<<4)<<4*z4(a));Vv=44+(15&A0(*(V*)&x,I0/2)>>I0%2*4);ns(z4(x),&v))
...
F(mm,QZ)F(No,QZ)F(Dt,QZ)f(dt,QZ)f(ff,P(tx?:Tx,uu(x))QZ)
G(NN,Qr(!ta)P(tx,nz(ua,x))Qn(ua>nx)_(jk(f?ua:0,f?nx:ua,x)))f(rr,Qz(2!=Tx)_R(2,nx,n(rc=sx[nx-1-i])))f(qr,Qr(1)0)f(ty,t(3,pt?tx:Tx))
